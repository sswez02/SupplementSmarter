        ...
        >
          ...
          <div className='text-center md:text-left w-full max-w-[320px]'>
            <h4 className='text-xs sm:text-sm font-semibold tracking-wide text-emerald-400'>
              <a
                href='https://www.chemistwarehouse.co.nz/'
                target='_blank'
                rel='noreferrer'
            ...
            <ul className='mt-3 sm:mt-4 space-y-1.5 sm:space-y-2 text-base sm:text-lg md:text-xl font-semibold italic tracking-tight'>
              <li>
                <a
                  href='/protein?retailer=chemistwarehouse&brand=Optimum%20Nutrition'
              ...
              <li>
                <a
                  href='/protein?retailer=chemistwarehouse&brand=Musashi'
                  className='hover:underline hover:opacity-80'
                >
                  Musashi
                </a>
              ...
              <li>
                <a
                  href='/protein?retailer=chemistwarehouse&brand=BSc'
                  className='hover:underline hover:opacity-80'
                >
                  BSc
                </a>
              ...
              <li>
                <a
                  href='/protein?retailer=chemistwarehouse&brand=Athena'
                  className='hover:underline hover:opacity-80'
                >
                  Athena
                </a>
