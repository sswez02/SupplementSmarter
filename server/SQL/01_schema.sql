...
CREATE UNIQUE INDEX IF NOT EXISTS price_history_category_product_weight_retailer_date_idx ON price_history(category, product_id, weight_grams, retailer, snapshot_date);
