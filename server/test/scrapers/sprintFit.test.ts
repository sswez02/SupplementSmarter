...
import { scrapeSprintFitProtein } from '@/scrapers/protein/sprintFit_Protein.js';
import { scrapeSprintFitCreatine } from '@/scrapers/creatine/sprintFit_Creatine.js';
import { CURRENCIES, RETAILERS, type Product } from '@/scrapers/common/types.js';

describe('SprintFit scraper', () => {
  it('returns protein products within time budget and with valid fields', async () => {
    const { products, errors } = await scrapeSprintFitProtein();
  ...
  it('returns creatine products within time budget and with valid fields', async () => {
    const { products, errors } = await scrapeSprintFitCreatine();
