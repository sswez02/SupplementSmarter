...
import { scrapeXplosivProtein } from '@/scrapers/protein/xplosiv_Protein.js';
import { scrapeXplosivCreatine } from '@/scrapers/creatine/xplosiv_Creatine.js';
import { CURRENCIES, RETAILERS, type Product } from '@/scrapers/common/types.js';

describe('Xplosiv scraper', () => {
  it('returns protein products within time budget and with valid fields', async () => {
    const { products, errors } = await scrapeXplosivProtein();
  ...
  it('returns creatine products within time budget and with valid fields', async () => {
    const { products, errors } = await scrapeXplosivCreatine();
